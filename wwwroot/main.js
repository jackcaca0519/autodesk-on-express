...
// const newPos = new THREE.Vector3(0, 100, 0);
...
const set_angle = document.getElementById('set_angle');
const to_angle = document.getElementById('to_angle');
const screenshot = document.getElementById('screenshot');
set_angle.onclick = () => setAngle();
to_angle.onclick = () => toAngle();
screenshot.onclick = () => takeScreenShot();
